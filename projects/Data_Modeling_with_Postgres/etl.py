...
def process_song_file(cur, filepath):
    """
    process and insert a json format song file
...
def process_log_file(cur, filepath):
    """
    process and insert a json format log file
    :param cur: cursor of the database
    :param filepath: path to file
    """
    # open log file
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = songplay_data = (row.timestamp, row.userId, row.level, songid, artistid, row.sessionId, row.location, row.userAgent)
